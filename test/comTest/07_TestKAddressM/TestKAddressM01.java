/*
javac -encoding utf8  TestKAddressM01.java
*/
...
public class TestKAddressM01 {	
	...
	public static void main(String[] arg) {
		...
		kaddressm.readKAddressbyPath("input01.json").print();
		
		String localPath = "C:/Users/will/Pictures/test/user/recordCloud";
		kaddressm.inputLocalRandom(new TokenS(ThreadWork.listDirectory(localPath), false)).print(); 
