...
/*
javac -encoding utf8  com/cloud/manga/henryTing/test/Key2CmdM02.java
*/
...
public class Key2CmdM02 extends com.cloud.manga.henryTing.main.MangaBase {
	...
	// public Key2CmdM02(GeoGet geoGet, GUIInterface guiInterface, GetFName getFName) throws JSONException {
	public Key2CmdM02(GeoGet geoGet, GUIInterface guiInterface) throws SDEBase {
		super(geoGet, guiInterface);
		// super.initializeWithOutFile(".", ".");
		super.initializeWithFilePath(".", "input01_02.json");
		// _getFName = getFName;
	}
	...
	public CmdMKey parseClickCmdMs(KeyEvent key) {
		...
		NameBuilder nameBuilder = new NameBuilder(super.getFName());
	...
	public void closeTheProgram() {
		super._closeTheProgram();
	}
	public void sendATouch(TouchUnit<CmdM> touchUnit) {
		super._touchDelayer.sendATouch(touchUnit);
	}
	public void runActionM(ActionM actionM) {
		super.runActionM(actionM);
	}
}