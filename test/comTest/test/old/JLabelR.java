...
/*
javac -encoding utf8  com/cloud/manga/henryTing/test/JLabelR.java
*/
...
public class JLabelR extends JLabel {
	...
	final int posi_x, posi_y;
	public JLabelR(LabelInfor infor) {
		super(infor._content);
		
		System.out.println("JLabelR");
		System.out.println(infor._content);
		
		Font font = new Font(infor.getFontType(), Font.PLAIN, infor.getFontSize());
		setFont(font);
		FontMetrics metrics = new FontMetrics(font){};
		bounds = metrics.getStringBounds(infor._content, null);
