...
/*
javac -encoding utf8  ./TestScreen02.java
*/
...
public class TestScreen02 extends JFrame
	implements KeyListener, GUIInterface, GeoGet // , GetFName
{
	public static void main(String[] args) {
		// if (args.length != 1) {
			...
			// return;
		// }
		// new TestScreen02(args[0]).initialize();
		new TestScreen02().initialize();
	}
	...
	public void refreshScreen() {
		...
		for (int ith=0; ith<_labelSize; ith++) {
			System.out.println(String.format("_labelTexts %02d\n", ith));
			_jPanel.add(_labelTexts[ith]);
		}
		for (int ith=0; ith<_imageSize; ith++) {
			System.out.println(String.format("_labelImages %02d\n", ith));
	...
	public void updateScreen(FrameInfor frameInfor) throws SDEBase {
		System.out.println("updateScreen start");
		int ith=0;
