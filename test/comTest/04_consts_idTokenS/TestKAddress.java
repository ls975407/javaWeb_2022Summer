/*
javac -encoding utf8  TestKAddress.java
*/
...
public class TestKAddress {	
	...
	public static void main(String[] arg) {
		...
		for (int ith=1; ith<=4; ith++) {
			localPaths = new String[] {String.format("%s%02d.json", finename, ith), String.format("%s%02d_01.json", finename, ith)};
